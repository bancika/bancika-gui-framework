 ...
 * 
 * In the main text field, the default font is used to display the font name. It is editable and
 * supports auto completion.
 * 
 * The last <code>n</code> selected fonts can be shown on the top by calling
 * <code>setRecentFontsCount(n)</code>.
 * 
 * This file is public domain. However, if you improve it, please share your work with
